var moneyurl = "https://ptx.transportdata.tw/MOTC/v2/Rail/Metro/ODFare/TYMC?%24top=420&%24format=JSON";
var timeurl = "https://ptx.transportdata.tw/MOTC/v2/Rail/Metro/S2STravelTime/TYMC?%24top=30&%24format=JSON";
var tvaule = $.getJSON(timeurl);
var mvaule = $.getJSON(moneyurl);
tvaule.done(function (msg) {
